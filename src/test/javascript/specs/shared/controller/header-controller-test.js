...
describe("HeaderController", function() {
  ...
  beforeEach(inject(function($rootScope, $controller, _localStorageService_, _$httpBackend_, _$state_, AuthorizationService, $q) {
    $state = _$state_;
    spyOn($state, 'reload');
    ...
    spyOn(AuthorizationService, 'logout').andReturn($q.when());
  }));
